...
public struct LoadingFeature {
    ...
    public struct State: Equatable {
        ...
        public var immediateCountByTarget: [Target: Int] = [:]
        public var delayedCountByTarget: [Target: Int] = [:]
        public var scheduledDelayedTargets = Set<Target>()
        public var visibleDelayedTargets = Set<Target>()
        public var visibleTargets = Set<Target>()
